...
CREATE TABLE planets
  (
    id SERIAL PRIMARY KEY,
    name TEXT,
    orbital_period_in_years DECIMAL,
    primary_body_id INTEGER REFERENCES primary_bodies ON DELETE SET NULL,
...
INSERT INTO planets
  (name, orbital_period_in_years, primary_body_id, galaxy_id, moons)
  VALUES
